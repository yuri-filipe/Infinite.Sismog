            ...
            try
            {
                ...
                while (reader.Read())
                {
                    var pedido = new ViewModelPedido
                    {
                        ...
                        Desconto = reader.IsDBNull(8) ? 0 : reader.GetInt64(8),
                        Subtotal = reader.IsDBNull(10) ? 0 : reader.GetInt64(10),
                        Total = reader.IsDBNull(11) ? 0 : reader.GetInt64(11),
                        FormaDePagamento = reader.IsDBNull(12) ? 0 : reader.GetInt64(11),
